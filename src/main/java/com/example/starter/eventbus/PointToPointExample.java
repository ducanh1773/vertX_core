...
public class PointToPointExample {
  public static void main(String[] args) {
    ...
    vertx.deployVerticle(new Receirver());
  }
  ...
  static class Receirver extends AbstractVerticle {
    private static final Logger LOG = LoggerFactory.getLogger(Receirver.class);
